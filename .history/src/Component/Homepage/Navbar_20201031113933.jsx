 ...
 <p className='firetext'>Fire Prayer house</p>
  ...
  <Navbar.Collapse id="basic-navbar-nav">
    <Nav className="mr-auto">
      ="#home">Home</Nav.Link>
      ="#link">Link</Nav.Link>
      itle="Dropdown" id="basic-nav-dropdown">
      .Item href="#action/3.1">Action</NavDropdown.Item>
      .Item href="#action/3.2">Another action</NavDropdown.Item>
      .Item href="#action/3.3">Something</NavDropdown.Item>
      .Divider />
      .Item href="#action/3.4">Separated link</NavDropdown.Item>
