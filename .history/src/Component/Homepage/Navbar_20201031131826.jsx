...
function Navbars() {
  return (
    <Navbar collapseOnSelect expand="xl " bg="info text-warning" variant="dark" className='fixed-top    '  >
      ...
      <Navbar.Toggle aria-controls="responsive-navbar-nav" text-warning/>
      <Navbar.Collapse id="responsive-navbar-nav">
        <Nav justify variant="tabs " bg='danger' ActiveKey="/"> 
