...
function Navbars() {
 ...
 <Navbar bg="light" expand="lg">
  ...
  nline>
  Control type="text" placeholder="Search" className="mr-sm-2" />
  on variant="outline-success">Search</Button>
  
  </Navbar.Collapse>
</Navbar>
    <>
      <Navbar bg="light" collapseOnSelect expand="sm" variant="danger" className='fixed-top'  >
